    ...
    public void run() {
        ...
        while (server.isRunning()) {
            ...
            try {
                ...
                Socket client = socket.accept();// 阻塞监听客户socket请求
                ...
                if (invo.getInterfaces() == ServerManager.class && invo.getMethod().getMethodName().equals("stop") && invo.getResult() instanceof Result && ((Result) invo.getResult()).isStop()) {
                    // 接收到关闭服务器命令
                    server.stop();
                }
