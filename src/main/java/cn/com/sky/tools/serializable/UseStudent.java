 ...
 *
 *  使用默认的序列化，transient变量和静态变量不会被序列化，如果要对静态成员与transient成员进行序列化时，我们只能通过 Externalizable或者是可控的 Serializable来实现。
 *
 *  </pre>
 */
public class UseStudent {
    ...
    @Test
    public void test2() {
        Student student = new Student("Tom", 'M', 20, 1.8, 55.5, "america");
        File file = new File("e:\\student.txt");
        try {
            file.createNewFile();
        } catch (IOException e) {
        ...
        try {
            ...
            System.out.println("nation = " + student.getNation());
