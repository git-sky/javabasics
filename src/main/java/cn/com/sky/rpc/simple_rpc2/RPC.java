package cn.com.sky.rpc.simple_rpc2;
...
import cn.com.sky.rpc.simple_rpc2.support.Client;
import cn.com.sky.rpc.simple_rpc2.support.Listener;
	...
	public static <T> T getProxy(final Class<T> clazz, String host, int port, int timeout) {
		...
		InvocationHandler handler = new InvocationHandler() {// 代理调用实例
			...
			public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
				...
				invo.setMethod(new cn.com.sky.rpc.simple_rpc2.protocal.Method(method.getName(), method.getParameterTypes()));
				invo.setParams(args);
				try {
					client.invoke(invo);
