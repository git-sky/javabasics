 ...
 * <pre>
 *
 * 只有实现了Serializable 和 Externalizable接口的类的对象才能被序列化。
 *
...
public class TestSerializable3 extends Parent implements Serializable {
    private static final long serialVersionUID = 1L;
    int version = 66;
    ...
    public static void main(String args[]) throws IOException {
        ...
        TestSerializable3 st = new TestSerializable3();
        oos.writeObject(st);
        oos.flush();
        oos.close();
    }
