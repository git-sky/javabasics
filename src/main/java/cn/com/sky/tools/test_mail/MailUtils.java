package cn.com.sky.tools.test_mail;
...
public class MailUtils {
	 ...
	 */
	public static boolean sendMail(String to, String subject, String body, List<String> filepath) throws AddressException, MessagingException, UnsupportedEncodingException {
		// 参数修饰
		if (body == null) {
			body = "";
		}
	...
	public static void main(String[] args) throws AddressException, UnsupportedEncodingException, MessagingException {
		...
		sendMail("000000@qq.com,000002@live.cn", "注册信息邮件", "注册邮件，有附件", filepath);
	}
}