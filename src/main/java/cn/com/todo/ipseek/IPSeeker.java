...
public class IPSeeker {
	...
	// ����IP�����ļ�
	private static final String IP_FILE = "/ky/data/ipdata/qqwry.dat";
	//
	...
	private IPSeeker() {
		...
		try {
			...
			System.out.println(IPSeeker.class.getResource(IP_FILE).toString());
	...
	public static void main(String[] args) {
		...
		for(int i=0;i<ips.length;i++){
			String ip=ips[i];
			IPSeeker ipseek = IPSeeker.getInstance();
			System.out.println(ip);
			String country = ipseek.getCountry(ip);
			String area = ipseek.getArea(ip);
