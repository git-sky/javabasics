...
public class Demo01 {
    ...
    public static void main(String[] args) {
        ...
        String jsonstr = "{\"base\":{" + "\"nonce\":\"" + randomStr + "\"," + "\"timestamp\":" + System.currentTimeMillis() + "," + "\"userId\":12," + "\"from\":\"android\"" + "}," + "\"name\":\"李四2\"" + "}";
