...
public class TestNavigable {
    ...
    public static void main(String[] arg) {
        ...
        /************ SortedMap接口 *******************************************/
        SortedMap<String, Employee> sm = new TreeMap<>();
        sm.put("123", jim);
        sm.put("234", bob);
        sm.put("345", gin);
        ...
        /************ SortedSet接口 *******************************************/
        SortedSet<Employee> ss = new TreeSet<Employee>(new Comparator<Employee>() {
        ...
        /************ NavigableSet接口 *******************************************/
        NavigableSet<Employee> ns = new TreeSet<>(new Comparator<Employee>() {
            @Override
            public int compare(Employee a, Employee b) {
                return a.getName().compareTo(b.getName());
            }
