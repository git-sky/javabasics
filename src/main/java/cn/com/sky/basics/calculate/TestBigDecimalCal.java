 ...
 * </pre>
 */
public class TestBigDecimalCal {
    ...
    public void test1() {
        ...
        //double类型计算不准确。
        double douleRatio = Double.valueOf(ratio);


        System.out.println(douleRatio);
        System.out.println(douleRatio * 10);
        System.out.println(douleRatio * 100);
        System.out.println(douleRatio * 1000);
        System.out.println(douleRatio * 10000);

        System.out.println("++++++++++++++++++++++++++++++++++++++");

        System.out.println((int) (douleRatio * 10));
        System.out.println((int) (douleRatio * 100));
        System.out.println((int) (douleRatio * 1000));
        System.out.println((int) (douleRatio * 10000));
        System.out.println("======================================");
